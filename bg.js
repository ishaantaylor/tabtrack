...
function nest(raw, nest) {
  ...
  for (var i in b) {            // this seems to be a problem
    var valid = (d.indexOf(b[i].fromid) == -1);
    if (valid) {     
